# nlp2024-template_v1.zip 内のファイル

Latex版
 nlp2024.cls: latex用の文書クラス
 nlp2024-sample.tex: 原稿執筆インストラクション，および，latex用のサンプル原稿
 nlp2024-sample.pdf: nlp2024-sample.texをPDF化したもの
 j_yourrefs.bib: サンプルbibファイル

Word版
 nlp2024-wordsample.doc: Word用のサンプル原稿 (可能な限り.docxの利用を推奨）
 nlp2024-wordsample.docx: Word用のサンプル原稿 
 nlp2024-wordsample.pdf: nlp2024-wordsample.docxをPDF化したもの

参考ファイル
 LICENSE: nlp2024.cls のライセンス条項
 latexmkrc: Overleafの日本語化用設定ファイルのサンプル
 README-latex.md: nlp2024.cls に関する説明文書
 README.txt: このファイル
